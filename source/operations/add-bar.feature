...
Feature: Add bar
   ...
   Scenario: Adding a bar to a tab shifts later tabs to the left and reindexes them
      ...
      And the bar at position 3 in tab "T" is a chord bar
      And the bar at position 3 in tab "T" has index 2
   ...
   Scenario: Adding a bar to a section of a tab shifts later tabs to the left and reindexes them
      ...
      And the bar at position 3 in section "S" of tab "T" is a chord bar
      And the bar at position 3 in section "S" of tab "T" has index 2
   ...
   Scenario: Adding a chord bar to a tab without strumming patterns, creates one
      ...
      And the chord bar at position 1 in tab "T" uses the strumming pattern 1
   ...
   Scenario: Adding a section bar to a tab without sections, creates one
      ...
      And the section bar at position 1 in tab "T" uses the section 1
